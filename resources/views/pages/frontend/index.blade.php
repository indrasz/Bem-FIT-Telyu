    ...
    <div class="kema-fit-information container-xxl p-3 mb-4 position-relative" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="d-sm-flex flex-row gap-5 text-center justify-content-center d-none d-sm-block">
            <div class="college-information p-3">
                ...
                <img src="{{ asset('frontend/images/logo-mahasiswa.png') }}" alt="college-logo" width="100" class="college-image ">
            ...
            <div class="college-information p-3">
                ...
                <img src="{{ asset('frontend/images/logo-ormawa.png') }}" alt="ormawa-logo" width="70" class="college-image">
                <div class="mt-3 text-uppercase">
                    Ormawa
                </div>
            </div>
            <div class="college-information p-3">
                ...
                <img src="{{ asset('frontend/images/logo-prodi.png') }}" alt="prodi-logo" width="120" class="d-none d-sm-block college-image">
                <div class="mt-3 text-uppercase">
                    Prodi
                </div>
            </div>
...
<section class="h-100 w-100" style="box-sizing: border-box; background-color: #ffffff">
    ...
    <div class="header-karya container-xxl  position-relative" style="font-family: 'Poppins', sans-serif">
        <div class="row justify-content-between p-md-4 p-2">
            <img src="{{ asset('frontend/images/benner_karya.png') }}" alt="Banner home">
        </div>
    </div>
</section>
    ...
    <div class="hot-news container-xxl px-3 pb-5 mb-4 position-relative"
        ...
        <div class="carousel gap-4" style="background: #ffffff !important;"
            ...
            <div class="box-border bg-white rounded-2xl hot-news-card mb-4">
                <div class="">
                    <div class="">
                        <img src="{{ asset('frontend/images/image-preview.png') }}" alt="preview" class="image-preview"  />
                    </div>
                    <div class="px-4 mt-2">
                        <div class="title p-md-2  mt-3">title</div>
                        <div class="text-preview p-md-2  ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Arcu vel cras ut varius a.</div>
                    </div>
...
<section class="h-100 w-100" style="box-sizing: border-box; background-color: #ffffff">
    ...
    <div class="header-karya container-xxl pb-5 position-relative" style="font-family: 'Poppins', sans-serif">
        <div class="row justify-content-between p-md-4 p-2">
           <img src="{{ asset('frontend/images/benner_karya2.png') }}" alt="Banner home">
        </div>

        <div class="row justify-content-between">
            <div class="col-12 col-md-6 p-2 p-md-4 mt-md-3" >
                <img src="{{ asset('frontend/images/sub_benner.png') }}" class="w-100" alt="Sub Banner home">
            </div>

            <div class="col-12 col-md-6 p-2 p-md-4 mt-md-3">
                <img src="{{ asset('frontend/images/subenner2.png') }}" class="w-100 " alt="Sub Banner home">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="hot-news container-xxl px-3 pb-5 mb-4 position-relative" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="carousel gap-4" style="background: #ffffff !important;"
            ...
            <div class="box-border bg-white rounded-2xl hot-news-card mb-4">
                <div class="">
                    <div class="">
                        <img src="{{ asset('frontend/images/image-preview.png') }}" alt="preview" class="image-preview" height="300" width="300" />
                    </div>
                    <div class="px-4 mt-2">
                        <div class="title p-2">title</div>
                        <div class="text-preview p-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Arcu vel cras ut varius a.</div>
                    </div>
                   <div class="d-flex justify-content-center align-content-center mt-3 pb-3">
                        <a href="#" class="btn btn-see-more py-2 px-5 text-white ">see more</a>
                   </div>
    ...
    <div class="podcast-bem-fit container-xxl  position-relative pb-5" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="podcast-link mt-4 p-4">
            <div class="carousel gap-4" style="background: #ffffff !important;"
                ...
                <iframe style="border-radius:12px" src="https://open.spotify.com/embed/show/2MUDGIF4iIxdvq1iGiWkBF?utm_source=generator"
    ...
    <div class="advokasi-banner container-xxl  position-relative pb-5" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="row justify-content-between p-4">
            ...
            <div class="col-12 col-md-6 text-center ps-lg-4">
                <img src="{{ asset('frontend/images/advokasi-banner.png') }}" alt="advokasi-banner" class="image-banner-advokasi">
            </div>
    ...
    <div class="medpart-banner container-xxl  position-relative pb-5" style="font-family: 'Poppins', sans-serif">
        <div class="row justify-content-between p-4">
            ...
            <div class="col-12 col-md-6 align-items-center text-center">
                <img src="{{ asset('frontend/images/medpart-banner.png') }}" alt="medpart-banner" class="image-banner-medpart">
