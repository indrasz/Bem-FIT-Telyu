...
<div class="row">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{url('dashboard/vokasi-store/update' . $items->id )}} " method="POST" enctype="multipart/form-data">
                {{-- {{ route('dashboard.vokasi-store.update', [$items->id]) }} --}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="product-name" class="form-control" value="{{ $items->name ?? '' }}" placeholder="Nama Produk">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                             <div class="row">
                                @forelse ($thumbnail_product as $thumbnail_item)
                                    ...
                                    <div class="col-sm-4 imgUp">
                                        <div class="imagePreview" style="background-image: url({{ Storage::url($thumbnail_item->photos) }})"></div>
                                        <label class="btn btn-success">
                                            Upload
                                            <input type="file" name="{{ 'photo['.$thumbnail_item->id.']' }}" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                                        </label>
                                        <i class="fa fa-times del bg-danger mx-2"></i>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" id="product-price" class="form-control" value="{{ $items->price ?? '' }}" placeholder="Harga Produk">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-control-label" for="product-link">URL Link</label>
                            <input type="text" name="url" id="product-link" class="form-control" value="{{ $items->url ?? '' }}" placeholder="Link URL Product">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-control-label">Description</label>
                            <textarea id="editor" name="description" class="form-control" placeholder="A few words about this product ...">{{ $items->description ?? '' }}</textarea>
                        </div>
                    </div>
