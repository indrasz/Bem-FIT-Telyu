            ...
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">
                    {{ count($accepted) }}
                  <span class="text-success text-sm font-weight-bolder">diterima</span>
                </h5>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="d-flex flex-column h-100">
                <p class="mb-1 pt-2 text-bold">Kabinet Titik Terang</p>
                <h5 class="font-weight-bolder">BEM Kema FIT Telkom University</h5>
                <p class="mb-5">BEM KEMA FIT tidak hanya sebuah organisasi, lebih dari itu ada tanggung jawab besar untuk meningkatkan taraf kesejahteraan mahasiswa. Untuk itu, Kami hadirkan Platform Advokasi Terpadu untuk menjadi wadah aktualisasi dari wajah #TitikTerang. Saluran aspirasi Anda sangat membantu kami untuk mewujudkannya.</p>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="avatar-group mt-2">
                      ...
                      <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Alexander Smith">
                        <img src="{{ asset('admin/assets/img/team-2.jpg') }}" alt="user3">
                      </a>
                      <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                ...
                <tr>
                  ...
                  <td>
                    <div class="avatar-group mt-2">
                      <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                        <img src="{{ asset('admin/assets/img/team-4.jpg') }}" alt="user6">
                      </a>
                      <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
