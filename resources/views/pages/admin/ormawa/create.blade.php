                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="editor" name="vision" class="form-control" placeholder="A few words about this Ormawa ..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-control-label" for="description">Misi Ormawa</label>
                                <textarea id="editor1" name="mission" class="form-control" placeholder="A few words about this Ormawa ..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-control-label" for="description">Description</label>
                                <textarea id="editor2" name="description" class="form-control" placeholder="A few words about this Ormawa ..."></textarea>
                            </div>
                        </div>
