...
<div class="row">
    <div class="card mb-4">
        ...
        <div class="card-body">
            <h6 class="heading-small text-muted mb-4">Detail Breaking News</h6>
            <form action="{{ route('dashboard.breaking-news.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
