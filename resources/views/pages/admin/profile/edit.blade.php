                ...
                <div class="row">
                        ...
                        <div class="form-group">
                             <div class="row">
                                <div class="col-sm-10 imgUp">
                                    <div class="imagePreview" style="background-image: url({{ Storage::url($profile->thumbnail) }})"></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $profile->name ?? '' }}" id="product-name" class="form-control" placeholder="Nama Anggota">
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" for="product-name">Position</label>
                            <input type="text" name="position" value="{{ $profile->position ?? '' }}" id="product-name" class="form-control" placeholder="Jabatan Anggota">
                        </div>
                        <div class="form-group">
                            ...
                            <select id="departments_id" name="departments_id" autocomplete="departments_id" class="form-control" required>
                                <option value="{{ $profile->departments_id  ?? '' }}"> {{$profile->department->name}} </option>
