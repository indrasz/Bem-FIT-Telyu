  ...
  <section class="h-100 w-100" style="box-sizing: border-box; background-color: #fcfcff">
    ...
    <div class="navbar-main container-xxl p-0 position-relative" style="font-family: 'Poppins', sans-serif">
        <nav class="navbar navbar-expand-lg navbar-light py-4 px-md-5 px-3" style="box-shadow: none;">
            <a href="#">
                <img style="margin-right: 0.75rem" src="{{ asset('frontend/images/main-logo.png') }}" alt="main-logo" width="150" />
            </a>
                    ...
                    <div class="modal-content modal-content bg-white border-0 pb-4">
                        <div class="modal-header" style="padding: 2rem; padding-bottom: 0">
                            <a class="modal-title" id="targetModalLabel">
                                <img style="margin-top: 0.5rem" src="{{ asset('frontend/images/main-logo.png') }}" alt="main-logo"
                                    width="90" />
                            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo">
                <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item me-4 dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" aria-expanded="false"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="cursor: pointer">
                            ...
                            <li>
                                <a href="#"
                                    class="dropdown-hover d-flex align-items-center justify-content-center text-start text-decoration-none dropdown-item">
                                    <img class=""
                                        src="http://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header5/Header-5-5.png"
                                        alt="" />
                                    <div class="flex-grow-1 ps-4">
