<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <img src="{{ asset('admin/assets/img/main-logo.png') }}" class="navbar-brand-img h-100" alt="main_logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            ...
            >
              ...
              <span class="nav-link-text ms-1">BEM Profile</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link
          ...
          <li class="nav-item">
            ...
            <a class="nav-link
              {{
                  (request()->is('dashboard/ormawa')) ||
                  request()->is('dashboard/ormawa/*') ||
                  request()->is('dashboard/*/ormawa') ||
                  request()->is('dashboard/*/ormawa/*') ? 'active' : ''
              }}" href="{{ route('dashboard.ormawa.index') }}
              "
            >
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                <i class="custom-color ni ni-active-40
                {{
                    (request()->is('dashboard/ormawa')) ||
                    request()->is('dashboard/ormawa/*') ||
                    request()->is('dashboard/*/ormawa') ||
        ...
        <li class="nav-item">
            ...
            {{
              ...
              <span class="nav-link-text ms-1">Vokasi Store</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link
        ...
        <li class="nav-item mt-3">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Manages Social Media</h6>
          </li>
        <li class="nav-item">
          <a class="nav-link  " href="#">
            ...
            <span class="nav-link-text ms-1">Spotify</span>
          </a>
        </li>
      </ul>
    </div>
